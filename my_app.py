...
class MainWin(QWidget):
    ...
    def initUI(self):
        ...
        self.layout.addWidget(self.instruction, alignment=Qt.AlignRight)
    ...
    def set_style(self):
        self.setStyleSheet(STYLE_SKY)

    def next_click(self):
        """Comportamiento de cambio de ventana"""
        self.tw = (
            TestWin()
        )  # Generando una instancia de la ventana de pruebas (second_win.py)
    ...
    def set_appear(self):
        ...
        )  # Definiendo dimensiones de la ventana (ancho, alto)
        self.move(
            win_x, win_y
        )  # El sitio en nuestra pantalla donde se va a mostrar la ventana (posicion x, posicion y)
